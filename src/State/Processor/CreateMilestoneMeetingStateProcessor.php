...
use App\Dto\Meeting\Input\CreateMilestoneMeetingInputDto;
...
class CreateMilestoneMeetingStateProcessor implements ProcessorInterface {
    ...
    /**
     * @inheritDoc
     * @param CreateMilestoneMeetingInputDto $data
     */
    ...
    ?MilestoneMeetingOutputDto {
        ...
        if (null !== $project) {
            try {
                ...
                $config->registerMapping(CreateMilestoneMeetingInputDto::class,
                ...
                $meeting->setScheduledAt($data->getScheduleAt());
